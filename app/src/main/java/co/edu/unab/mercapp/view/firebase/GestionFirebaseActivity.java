...
public class GestionFirebaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(GestionFirebaseActivity.this, EditarProductoActivity.class);
                intent.putExtra("idDocumento",producto.getId());
                //startActivity(intent); //sem 4 s4 749a,
    ...
    private void getAllData() {
        ...
        productos.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    //para vincular la lista 640am s4 sem 4
    private void cargarLista(ArrayList<Producto> datos) {
        ListView lista = findViewById(R.id.lista);
        ArrayAdapter<Producto> adapter = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_1,datos);
